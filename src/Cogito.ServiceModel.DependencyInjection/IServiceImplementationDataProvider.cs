namespace Cogito.ServiceModel.DependencyInjection
{
    ...
    /// <summary>
    /// Defines a strategy for resolving which service type should be used for hosting vs. which type is the actual
    ...
    public interface IServiceImplementationDataProvider
    {
        ...
        /// service host and how to resolve the implementation.
        /// </returns>
