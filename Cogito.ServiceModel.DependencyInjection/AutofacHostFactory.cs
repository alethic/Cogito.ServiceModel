...
namespace Cogito.ServiceModel.DependencyInjection
{
    ...
    /// setting the <see cref="Cogito.ServiceModel.DependencyInjection.AutofacHostFactory.ServiceImplementationDataProvider"/>
    /// with a strategy implementation.
    /// </para>
    /// <para>
    /// If <see cref="Cogito.ServiceModel.DependencyInjection.AutofacHostFactory.ServiceImplementationDataProvider"/>
    /// is <see langword="null" /> a new instance of <see cref="Cogito.ServiceModel.DependencyInjection.DefaultServiceImplementationDataProvider"/>
    /// will be used.
    /// </para>
    /// <para>
    /// You may configure additional behaviors or other aspects of generated
    /// service instances by setting the <see cref="Cogito.ServiceModel.DependencyInjection.AutofacHostFactory.HostConfigurationAction"/>.
    ...
    public abstract class AutofacHostFactory : ServiceHostFactory
    {
        ...
        /// <remarks>
        /// <para>
        /// If <see cref="Cogito.ServiceModel.DependencyInjection.AutofacHostFactory.HostConfigurationAction"/>
